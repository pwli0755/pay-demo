...
func (rq *RefundQuery) ForUpdate(opts ...sql.LockOption) *RefundQuery {
...
func (rq *RefundQuery) ForShare(opts ...sql.LockOption) *RefundQuery {
	if rq.driver.Dialect() == dialect.Postgres {
		rq.Unique(false)
	}
	rq.modifiers = append(rq.modifiers, func(s *sql.Selector) {
...
func (rgb *RefundGroupBy) sqlScan(ctx context.Context, v any) error {
...
func (rs *RefundSelect) sqlScan(ctx context.Context, v any) error {
