...
func Price(v uint64) predicate.Product {
	return predicate.Product(func(s *sql.Selector) {
...
func PriceEQ(v uint64) predicate.Product {
	return predicate.Product(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldPrice), v))
	})
}
...
func PriceNEQ(v uint64) predicate.Product {
	return predicate.Product(func(s *sql.Selector) {
...
func PriceIn(vs ...uint64) predicate.Product {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func PriceNotIn(vs ...uint64) predicate.Product {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func PriceGT(v uint64) predicate.Product {
	return predicate.Product(func(s *sql.Selector) {
...
func PriceGTE(v uint64) predicate.Product {
	return predicate.Product(func(s *sql.Selector) {
...
func PriceLT(v uint64) predicate.Product {
	return predicate.Product(func(s *sql.Selector) {
...
func PriceLTE(v uint64) predicate.Product {
	return predicate.Product(func(s *sql.Selector) {
